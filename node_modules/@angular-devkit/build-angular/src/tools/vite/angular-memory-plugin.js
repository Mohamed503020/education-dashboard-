...
async function loadViteClientCode(file) {
        ...
        // Attempt to remove the suggestion about disabling the overlay in Vite client
        // The Vite client message may change across versions, so only perform the
        // targeted replacement when the expected text is present. If not present,
        // return the original contents to avoid throwing an exception and breaking
        // the dev server.
        ...
        try {
            ...
            // ignore replacement errors and fall back to originalContents
            updatedContents = originalContents;
        }
        // If replacement had no effect, just return original contents instead of asserting.
